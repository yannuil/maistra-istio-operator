...
var v2_6ChartMapping = map[string]chartRenderingDetails{
	DiscoveryChart: {
...
type versionStrategyV2_6 struct {
	Ver
	conversionImpl v2xConversionStrategy
}

var _ VersionStrategy = (*versionStrategyV2_6)(nil)

func (v *versionStrategyV2_6) SetImageValues(_ context.Context, _ *common.ControllerResources, smcpSpec *v1.ControlPlaneSpec) error {
	if err := common.UpdateField(smcpSpec.Istio, "grafana.image", common.Config.OLM.Images.V2_6.Grafana); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "pilot.image", common.Config.OLM.Images.V2_6.Pilot); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "prometheus.image", common.Config.OLM.Images.V2_6.Prometheus); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "prometheusConfigReloader.image", common.Config.OLM.Images.V2_6.PrometheusConfigReloader); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "global.proxy.image", common.Config.OLM.Images.V2_6.ProxyV2); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "rateLimiting.rls.image", common.Config.OLM.Images.V2_6.RLS); err != nil {
		return err
	}
	return nil
}

func (v *versionStrategyV2_6) IsClusterScoped(spec *v2.ControlPlaneSpec) (bool, error) {
	return spec.Mode == v2.ClusterWideMode, nil
}

func (v *versionStrategyV2_6) ValidateV1(_ context.Context, _ client.Client, _ *v1.ServiceMeshControlPlane) error {
	return fmt.Errorf("must use v2 ServiceMeshControlPlane resource for v2.0+ installations")
}

func (v *versionStrategyV2_6) ValidateV2(ctx context.Context, cl client.Client, meta *metav1.ObjectMeta, spec *v2.ControlPlaneSpec) error {
	var allErrors []error
...
func (v *versionStrategyV2_6) validateRuntime(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV2_6) validateMixerDisabled(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV2_6) validateAddons(spec *v2.ControlPlaneSpec, allErrors []error) []error {
	if spec.Addons == nil {
		return allErrors
	}
...
func (v *versionStrategyV2_6) validateExtensionProviders(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV2_6) validateExtensionProviderZipkin(spec *v2.ControlPlaneSpec, allErrors []error) []error {
	if spec.MeshConfig == nil || spec.MeshConfig.ExtensionProviders == nil {
		return allErrors
	}
...
func (v *versionStrategyV2_6) validateGeneralLoggingComponentLevels(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV2_6) validateServiceMeshExtensionsRemoved(ctx context.Context, cl client.Client, smcp metav1.Object) error {
...
func (v *versionStrategyV2_6) ValidateV2Full(ctx context.Context, cl client.Client, meta *metav1.ObjectMeta, spec *v2.ControlPlaneSpec) error {
	var allErrors []error
...
func (v *versionStrategyV2_6) ValidateDowngrade(ctx context.Context, cl client.Client, smcp metav1.Object) error {
	// TODO: what might prevent us from downgrading?
	return nil
}

func (v *versionStrategyV2_6) ValidateUpgrade(ctx context.Context, cl client.Client, smcp metav1.Object) error {
	return v.validateServiceMeshExtensionsRemoved(ctx, cl, smcp)
}

func (v *versionStrategyV2_6) ValidateUpdate(ctx context.Context, cl client.Client, oldSMCPObject, newSMCPObject metav1.Object) error {
	return nil
}

func (v *versionStrategyV2_6) ValidateRequest(ctx context.Context, cl client.Client, req admission.Request, obj metav1.Object) admission.Response {
	smcp, err := toSMCP(obj)
	if err != nil {
...
func (v *versionStrategyV2_6) isRequesterAllowedToCreateSMCPInAnyNamespace(ctx context.Context, cl client.Client, req admission.Request) (bool, error) {
...
func (v *versionStrategyV2_6) GetChartInstallOrder() [][]string {
	return v2_6ChartOrder
}

// TODO: consider consolidating this with 2.0 rendering logic
func (v *versionStrategyV2_6) Render(ctx context.Context, cr *common.ControllerResources, cniConfig cni.Config,
	...
	if isComponentEnabled(spec.Istio, v2_6ChartMapping[TracingChart].enabledField) {
	...
	if isComponentEnabled(spec.Istio, v2_6ChartMapping[PrometheusChart].enabledField) {
	...
	if isComponentEnabled(spec.Istio, v2_6ChartMapping[KialiChart].enabledField) {
	...
	for name, chartDetails := range v2_6ChartMapping {
		...
		if chartDetails.enabledField == "" || isComponentEnabled(spec.Istio, chartDetails.enabledField) {
			...
			chart := path.Join(v.GetChartsDir(), v2_6ChartMapping[name].path)
...
func (v *versionStrategyV2_6) renderIngressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
	values *v1.HelmValues, userIDAutoassigned bool,
) (map[string][]manifest.Manifest, map[string]interface{}, error) {
	return v.renderGateway(name, namespace, kubeVersion, v2_6ChartMapping[GatewayIngressChart].path, "istio-ingressgateway", gateways, values, userIDAutoassigned)
}

func (v *versionStrategyV2_6) renderEgressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
	values *v1.HelmValues, userIDAutoassigned bool,
) (map[string][]manifest.Manifest, map[string]interface{}, error) {
	return v.renderGateway(name, namespace, kubeVersion, v2_6ChartMapping[GatewayEgressChart].path, "istio-egressgateway", gateways, values, userIDAutoassigned)
}

func (v *versionStrategyV2_6) renderGateway(name, namespace, kubeVersion string, chartPath string, typeName string,
...
func (v *versionStrategyV2_6) GetExpansionPorts() []corev1.ServicePort {
	return v.conversionImpl.GetExpansionPorts()
}

func (v *versionStrategyV2_6) GetTelemetryType(in *v1.HelmValues, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled bool) v2.TelemetryType {
	return v.conversionImpl.GetTelemetryType(in, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled)
}

func (v *versionStrategyV2_6) GetPolicyType(in *v1.HelmValues, mixerPolicyEnabled, mixerPolicyEnabledSet, remoteEnabled bool) v2.PolicyType {
	return v.conversionImpl.GetPolicyType(in, mixerPolicyEnabled, mixerPolicyEnabledSet, remoteEnabled)
}

func (v *versionStrategyV2_6) GetTrustDomainFieldPath() string {
	return "meshConfig.trustDomain"
}

func (v *versionStrategyV2_6) validateGlobal(
...
func (v *versionStrategyV2_6) createMemberRoll(ctx context.Context, cr *common.ControllerResources, smcp *v2.ServiceMeshControlPlane) error {
	log := common.LogFromContext(ctx)
