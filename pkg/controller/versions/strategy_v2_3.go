...
type versionStrategyV2_3 struct {
	Ver
	conversionImpl v2xConversionStrategy
}

var _ VersionStrategy = (*versionStrategyV2_3)(nil)

func (v *versionStrategyV2_3) SetImageValues(_ context.Context, _ *common.ControllerResources, smcpSpec *v1.ControlPlaneSpec) error {
	if err := common.UpdateField(smcpSpec.Istio, "grafana.image", common.Config.OLM.Images.V2_3.Grafana); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "pilot.image", common.Config.OLM.Images.V2_3.Pilot); err != nil {
		return err
	}
	...
	if err := common.UpdateField(smcpSpec.Istio, "rateLimiting.rls.image", common.Config.OLM.Images.V2_3.RLS); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.ThreeScale, "image", common.Config.OLM.Images.V2_3.ThreeScale); err != nil {
		return err
	}
	return nil
}
...
func (v *versionStrategyV2_3) validateMixerDisabled(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV2_3) validateAddons(spec *v2.ControlPlaneSpec, allErrors []error) []error {
	if spec.Addons == nil {
		return allErrors
	}
...
func (v *versionStrategyV2_3) ValidateUpdate(ctx context.Context, cl client.Client, oldSMCPObject, newSMCPObject metav1.Object) error {
	...
	if oldClusterScoped != newClusterScoped {
		return fmt.Errorf("field spec.techPreview.%s is immutable; to change its value, delete the ServiceMeshControlPlane and recreate it",
			v2.TechPreviewControlPlaneModeKey)
	}
	return nil
}

func toSMCP(obj metav1.Object) (*v2.ServiceMeshControlPlane, error) {
	switch s := obj.(type) {
	case *v1.ServiceMeshControlPlane:
		return nil, fmt.Errorf("must use v2 ServiceMeshControlPlane resource for v2.0+ installations")
	case *v2.ServiceMeshControlPlane:
		return s, nil
	default:
		return nil, fmt.Errorf("unknown ServiceMeshControlPlane type: %T", obj)
	}
}

func (v *versionStrategyV2_3) ValidateRequest(ctx context.Context, cl client.Client, req admission.Request, obj metav1.Object) admission.Response {
	smcp, err := toSMCP(obj)
	if err != nil {
...
func (v *versionStrategyV2_3) Render(ctx context.Context, cr *common.ControllerResources, cniConfig cni.Config,
	...
	if isComponentEnabled(spec.Istio, v2_3ChartMapping[TracingChart].enabledField) {
	...
	for name, chartDetails := range v2_3ChartMapping {
...
func (v *versionStrategyV2_3) GetTelemetryType(in *v1.HelmValues, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled bool) v2.TelemetryType {
	return v.conversionImpl.GetTelemetryType(in, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled)
}

func (v *versionStrategyV2_3) GetPolicyType(in *v1.HelmValues, mixerPolicyEnabled, mixerPolicyEnabledSet, remoteEnabled bool) v2.PolicyType {
